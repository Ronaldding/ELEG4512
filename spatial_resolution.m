...
close all
clc
hw1a=imread('./HW/hw1.tif');

%% Creating
laplacianFilter = fspecial('laplacian',0);

figure;
subplot(2,4,1);imshow(hw1a);
subplot(2,4,2);imshow(hw1b);
subplot(2,4,3);imshow(hw1c);
subplot(2,4,4);imshow(hw1d);
subplot(2,4,5);imshow(hw1e);
subplot(2,4,6);imshow(hw1f);
subplot(2,4,7);imshow(hw1g);
subplot(2,4,8);imshow(hw1h);
